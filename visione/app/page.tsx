...
export default function Home() {
  ...
  return (
    <div ref={container} className="bg-purple-500 flex flex-col items-center justify-center gap-20 m-auto w-[80vw] h-[80vh] p-10" >
      ...
      <button ref={buttonElement} className="w-40 h-1/3 rounded-full border-solid border-2 border-white text-white self-center transition-colors hover:bg-red-400 hover:border-white hover:text-purple-900" onClick={() => {
        handleClick()
      }}>click me</button>
